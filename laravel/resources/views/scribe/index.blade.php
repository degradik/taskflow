    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-projects--id-">Получить конкретный проект</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-projects--id-">
                                <a href="#endpoints-PUTapi-projects--id-">Обновить проект</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-projects--id-">
                                <a href="#endpoints-DELETEapi-projects--id-">Удалить проект</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-projects--project_id--users">
                                <a href="#endpoints-POSTapi-projects--project_id--users">POST api/projects/{project_id}/users</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-projects--project_id--users--user_id-">
                                <a href="#endpoints-DELETEapi-projects--project_id--users--user_id-">DELETE api/projects/{project_id}/users/{user_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
               ...
               value="2025-03-23T19:00:49"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-03-23T19:00:49</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-projects--id-">Получить конкретный проект</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/projects/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/projects/consequatur';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<p>The ID of the project. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-projects--id-">Обновить проект</h2>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="status"                data-endpoint="PUTapi-projects--id-"
               value="17"
               data-component="body">
    <br>
<p>Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="deadline"                data-endpoint="PUTapi-projects--id-"
               value="2025-03-23T19:00:49"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-03-23T19:00:49</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-projects--id-">Удалить проект</h2>
...
<p>The ID of the project. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-projects--project_id--users">POST api/projects/{project_id}/users</h2>
...
<span id="example-requests-POSTapi-projects--project_id--users">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/projects/1/users" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"user_id\": \"consequatur\",
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/projects/1/users';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-projects--project_id--users">
</span>
<span id="execution-results-POSTapi-projects--project_id--users" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-projects--project_id--users"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-projects--project_id--users"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-projects--project_id--users" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-projects--project_id--users">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-projects--project_id--users" data-method="POST"
      data-path="api/projects/{project_id}/users"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-projects--project_id--users', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-projects--project_id--users"
                    onclick="tryItOut('POSTapi-projects--project_id--users');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-projects--project_id--users"
                    onclick="cancelTryOut('POSTapi-projects--project_id--users');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-projects--project_id--users"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/projects/{project_id}/users</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-projects--project_id--users"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-projects--project_id--users"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="project_id"                data-endpoint="POSTapi-projects--project_id--users"
               value="1"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="POSTapi-projects--project_id--users"
               value="consequatur"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="POSTapi-projects--project_id--users"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-projects--project_id--users--user_id-">DELETE api/projects/{project_id}/users/{user_id}</h2>
...
<span id="example-requests-DELETEapi-projects--project_id--users--user_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost/api/projects/1/users/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/projects/1/users/1';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-DELETEapi-projects--project_id--users--user_id-">
</span>
<span id="execution-results-DELETEapi-projects--project_id--users--user_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-projects--project_id--users--user_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-projects--project_id--users--user_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-projects--project_id--users--user_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-projects--project_id--users--user_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-projects--project_id--users--user_id-" data-method="DELETE"
      data-path="api/projects/{project_id}/users/{user_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-projects--project_id--users--user_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-projects--project_id--users--user_id-"
                    onclick="tryItOut('DELETEapi-projects--project_id--users--user_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-projects--project_id--users--user_id-"
                    onclick="cancelTryOut('DELETEapi-projects--project_id--users--user_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-projects--project_id--users--user_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-red">DELETE</small>
            <b><code>api/projects/{project_id}/users/{user_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-projects--project_id--users--user_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-projects--project_id--users--user_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="project_id"                data-endpoint="DELETEapi-projects--project_id--users--user_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the project. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="user_id"                data-endpoint="DELETEapi-projects--project_id--users--user_id-"
               value="1"
               data-component="url">
    <br>
